...
import (
	...
	_ "github.com/openGemini/openGemini/lib/vGram/gramTextSearch/gramFuzzyQuery"
	...
	_ "github.com/openGemini/openGemini/lib/vGram/gramTextSearch/gramRegexQuery"
	"github.com/openGemini/openGemini/lib/vToken/tokenTextSearch/tokenFuzzyQuery"
	_ "github.com/openGemini/openGemini/lib/vToken/tokenTextSearch/tokenFuzzyQuery"
	...
	_ "github.com/openGemini/openGemini/lib/vToken/tokenTextSearch/tokenRegexQuery"
	"os"
)
...
func (clvSearch *CLVSearch) SearchIndexTreeFromDisk(clvType CLVIndexType, measurement string, fieldKey string, path string) {
	if clvType == VGRAM {
		...
		if err == nil {
			clvSearch.fileNames = clvSearch.fileNames[0:1]
