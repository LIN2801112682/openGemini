...
/*
	constructsion method of ParseTreeNode
*/
...
/*
	generate parseTree use two steps below
*/
...
/*
	the first step
	Segmentation and reconstruction of regular expressions
*/
...
/*
	the second step
	form a syntax tree use the result generated by the split function
*/
func Compile(expression *[]*ParseTreeNode) *ParseTreeNode {

	// in fact , OPTR and OPND are stacks
